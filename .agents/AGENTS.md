...
- **Context-Sensitive Translation**: When a term has both a strict legal translation and a more natural everyday equivalent, choose based on the context. For example, translate "promissory note" as "차용증" in informal or family contexts (like between father and son), but use "약속어음" in strict commercial or corporate contexts.
- **Avoid Archaic Legal Jargon**: Do NOT use outdated legal terms like "설시(하다)", "방론", or "수교(하다)". Instead, depending on the context, use more natural alternatives such as "판시하다" (ruled/held), "지적하다" (pointed out), "설명하다" (explained), "의견/발언" (for dicta), or "직접 전달하다" (for hand-delivered). Prioritize everyday Korean usage over forced literal translations while maintaining professional academic tone.
...
- **Do NOT translate "freehold" or "leasehold"**: When translating property or land law terms, do NOT translate "freehold" (e.g., as "자유보유권") or "leasehold" into Korean. Always use the original English terms capitalized as "Freehold" and "Leasehold".
