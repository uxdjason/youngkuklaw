...
description: 'Routledge v Grant (1828): an offeror may revoke an offer at any time
  before acceptance, even within a fixed period. Key case on revocation and the mirror
  image rule.'
seoTitle: Routledge v Grant (1828) | Offer Revocation Explained
metaDescription: 'Routledge v Grant (1828): an offeror may revoke an offer at any
  time before acceptance, even within a fixed period. Key case on revocation and the
  mirror image rule.'
focusKeyphrase: Routledge v Grant
longTailKeywords:
- revocation of offer before acceptance contract law
- fixed period offer revocation English law
- mirror image rule acceptance contract law case
- Routledge v Grant ratio decidendi
- offer and acceptance English contract law cases
uiTags:
- Revocation
- Offer & Acceptance
uiDescription: An offeror who grants a fixed period for acceptance may still revoke
  the offer at any time before acceptance occurs — granting time alone does not bind
  the offeror without consideration.
