---
wpId: 713
pubDate: '2025-07-22T09:00:00+00:00'
lang: en
category: contract-law-cases
slug: adams-v-lindsell
title: Adams v Lindsell
description: 'Adams v Lindsell established the postal rule: acceptance by post takes
  effect when the letter is posted, not when received. Key English contract law case.'
seoTitle: Adams v Lindsell (1818) | Postal Rule Contract Law
metaDescription: 'Adams v Lindsell established the postal rule: acceptance by post
  takes effect when the letter is posted, not when received. Key English contract
  law case.'
focusKeyphrase: Adams v Lindsell postal rule
longTailKeywords:
- Adams v Lindsell 1818 case summary
- postal rule acceptance contract law
- when does postal acceptance take effect
- Adams v Lindsell ratio decidendi
- offer and acceptance by post English law
uiTags:
- Postal Rule
- Acceptance
uiDescription: A wool dealer misdirected his offer letter, causing delay. The court
  held that posting an acceptance completes a contract immediately — the foundation
  of the postal rule.
...
claimant: Adams and others
defendantRole: Defendant
defendant: Lindsell and another
courtLink: https://www.bailii.org/ew/cases/EWHC/KB/1818/J59.html
---
...
This case is the foundational authority for the postal rule in English contract law. It was adopted and applied in subsequent decisions including [Household Fire v Grant (1879)](/household-fire-v-grant) and considered in [Stevenson v McLean (1880)](/stevenson-v-mclean), and has continued to define the point at which postal acceptance becomes effective.
