...
The definition of consideration from this case continues to be cited as the foundational statement of the doctrine and has been applied and affirmed in numerous subsequent decisions. It is often read alongside [Chappell v Nestlé [1960]](/chappell-v-nestle), which confirmed that consideration need not be adequate, and [Thomas v Thomas (1842)](https://www4.commonlii.org/uk/cases/EngR/1842/260.pdf), which distinguished consideration from motive. The principle that a pre-existing debt may constitute good consideration also connects to debates explored in [Foakes v Beer [1884]](/foakes-v-beer) and [Pinnel's Case (1602)](/pinnels-case).
