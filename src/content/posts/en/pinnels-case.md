...
description: Pinnel's Case (1602) established that payment of a lesser sum cannot
  ...
  contract law.
seoTitle: Pinnel's Case (1602) | Part Payment & Accord and Satisfaction
metaDescription: Pinnel's Case (1602) established that payment of a lesser sum cannot
  satisfy a greater debt. Learn the rule, its exceptions, and its impact on English
  contract law.
focusKeyphrase: Pinnel's Case
longTailKeywords:
- Pinnel's Case part payment rule
- accord and satisfaction lesser sum English law
- Pinnel's Case exceptions to part payment
- Pinnel's Case Foakes v Beer relationship
- can part payment discharge a debt English contract law
uiTags:
- Accord & Satisfaction
- Part Payment
uiDescription: Payment of a lesser sum on the due date cannot in law satisfy a greater
  debt — but early payment, payment at a different place, or a non-monetary gift may
  constitute valid satisfaction.
...
The rule in this case was subsequently followed and confirmed by the House of Lords in [Foakes v Beer [1884]](/foakes-v-beer), which applied the principle that an agreement to accept part payment of a debt cannot discharge the full debt in the absence of fresh consideration. The rule was further applied in [D & C Builders v Rees [1965]](/d-c-builders-ltd-v-rees), confirming its continuing authority.
