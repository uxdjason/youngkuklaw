...
description: Adams v Lindsell은 승낙 서신을 발송한 시점에 계약이 성립한다는 우편 규칙(postal rule)을 확립한 영국
  계약법의 핵심 판례이다.
seoTitle: Adams v Lindsell | 우편 규칙 판례
metaDescription: Adams v Lindsell은 승낙 서신을 발송한 시점에 계약이 성립한다는 우편 규칙(postal rule)을 확립한
  영국 계약법의 핵심 판례이다.
focusKeyphrase: Adams v Lindsell 우편 규칙
longTailKeywords:
- Adams v Lindsell 판례 요약
- 우편 규칙 계약법 승낙 시점
- 청약 승낙 우편 발송 계약 성립
...
- 우편 규칙
- 승낙
uiDescription: 피고가 청약 서신을 잘못 발송해 지연이 발생한 사건. 법원은 승낙 서신을 우편으로 발송한 순간 계약이 성립한다는 우편 규칙을
  확립하였다.
...
원고는 합의된 계약에 따른 양모 미인도를 이유로 소를 제기하면서, 승낙 서신을 우편으로 발송한 시점에 구속력 있는 계약이 성립하였다고 주장하였다. 피고는 [Cooke v Oxley (1790)](https://youngkuklaw.com/case-archive/cooke-v-oxley.html)를 근거로, 원고의 승낙이 실제로 수령되기 전까지는 구속력 있는 계약이 존재할 수 없으며, 수령 시점에 피고는 이미 제3자에게 양모를 매도함으로써 청약을 철회한 상태였다고 주장하였다.
...
이 사건은 영국 계약법상 우편 규칙의 근본적인 판례 권위로서, [Household Fire v Grant (1879)](/ko/household-fire-v-grant) 등 후속 판결에서 채택·적용되었고, [Stevenson v McLean (1880)](/ko/stevenson-v-mclean)에서도 검토되었으며, 우편에 의한 승낙이 효력을 발생하는 시점을 지속적으로 규정하여 왔다.
