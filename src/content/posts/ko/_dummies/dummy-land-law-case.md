---
lang: ko
title: "Street v Mountford 판례 분석"
description: "임대차(lease)와 사용허가(licence)의 구별 기준을 제시한 대표적인 토지법 판례."
...
이 글은 **Street v Mountford 판례 분석** ([1985] AC 809) 판례에 대한 분석이다. 영국 커먼로 체계에서 본 판례는 법학 교육 및 실무의 핵심적 이정표 역할을 수행한다.
