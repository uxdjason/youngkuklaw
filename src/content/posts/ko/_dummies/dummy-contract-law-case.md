---
lang: ko
title: "Carlill v Carbolic Smoke Ball Company 판례 분석"
description: "일방계약 및 대인 청약의 법리를 확립한 기념비적인 계약법 판례."
...
이 글은 **Carlill v Carbolic Smoke Ball Company 판례 분석** ([1893] 1 QB 256) 판례에 대한 분석이다. 영국 커먼로 체계에서 본 판례는 법학 교육 및 실무의 핵심적 이정표 역할을 수행한다.
