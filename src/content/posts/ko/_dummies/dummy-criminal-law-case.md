---
lang: ko
title: "R v Woollin 판례 분석"
description: "살인죄에 있어서 간접적 고의(indirect intention)를 규정한 주요 형사법 판례."
...
이 글은 **R v Woollin 판례 분석** ([1999] 1 AC 82) 판례에 대한 분석이다. 영국 커먼로 체계에서 본 판례는 법학 교육 및 실무의 핵심적 이정표 역할을 수행한다.
